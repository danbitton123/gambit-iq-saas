...
.decision-alert { border:1px solid rgba(141,163,180,.18);border-left:5px solid #f5b84b;background:radial-gradient(circle at 90% 0,rgba(245,184,75,.08),transparent 30%),linear-gradient(145deg,rgba(10,38,48,.98),rgba(5,21,30,.99));border-radius:16px;padding:19px 20px;margin:8px 0 15px;box-shadow:0 14px 34px rgba(0,0,0,.14); }.decision-critical { border-left-color:#ff5b57; }.decision-high { border-left-color:#f59e42; }.decision-medium { border-left-color:#d9a72e; }
.decision-alert-head { display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:12px;border-bottom:1px solid rgba(141,163,180,.14);padding-bottom:13px;margin-bottom:14px; }.decision-alert-icon { width:43px;height:43px;display:grid!important;place-items:center;border-radius:12px;background:rgba(245,184,75,.12);color:#f5c76b;font-size:24px; }.decision-critical .decision-alert-icon { background:rgba(255,91,87,.12);color:#ff8d89; }.decision-alert-head div { display:flex;flex-direction:column;gap:3px; }.decision-alert-head small { color:#d9a72e;font-size:.61rem;font-weight:800;letter-spacing:.09em; }.decision-alert-head strong { color:#f4f7fb;font:700 1.08rem Manrope; }.decision-alert-head > b { color:#9eb0bc;border:1px solid rgba(141,163,180,.2);border-radius:8px;padding:5px 8px;font-size:.68rem; }
.decision-alert-kpis { display:grid;grid-template-columns:1.25fr 1fr 1fr 1fr;gap:9px;margin-bottom:14px; }.decision-alert-kpis > div { min-height:82px;display:flex;flex-direction:column;gap:6px;background:rgba(141,163,180,.055);border:1px solid rgba(141,163,180,.1);border-radius:10px;padding:11px; }.decision-alert-kpis span,.decision-alert-explain span { color:#8098a6;font-size:.58rem;font-weight:800;letter-spacing:.08em; }.decision-alert-kpis strong { color:#eaf1f4;font:600 .84rem Manrope;overflow-wrap:anywhere; }
.decision-alert-explain { display:grid;grid-template-columns:1fr 1fr;gap:14px; }.decision-alert-explain > div { border-top:1px solid rgba(141,163,180,.1);padding-top:11px; }.decision-alert-explain p { color:#a9bac4;font-size:.76rem;line-height:1.48;margin:5px 0 0; }.decision-alert footer { display:flex;align-items:center;flex-wrap:wrap;gap:6px;color:#8da3b4;font-size:.66rem;margin-top:14px; }.decision-alert footer .material-symbols-rounded { color:#53b8c8;font-size:15px;margin-left:8px; }.decision-alert footer .material-symbols-rounded:first-child { margin-left:0; }
.recommendation-action { min-height:218px;border:1px solid rgba(39,209,127,.18);background:linear-gradient(145deg,rgba(9,38,47,.96),rgba(5,22,31,.99));border-radius:14px;padding:16px;margin:6px 0 12px; }.recommendation-action header { display:flex;align-items:flex-start;gap:9px; }.recommendation-action header > span { color:#76e8ad;background:rgba(39,209,127,.1);border-radius:6px;padding:4px 6px;font-size:.62rem;font-weight:800; }.recommendation-action header strong { color:#f4f7fb;font:600 .91rem Manrope; }.recommendation-action > p { color:#a8bac4;font-size:.75rem;line-height:1.45;min-height:52px; }.recommendation-action > div { display:grid;grid-template-columns:repeat(4,1fr);gap:7px; }.recommendation-action > div span { display:flex;flex-direction:column;gap:3px;color:#78909e;font-size:.54rem;font-weight:800; }.recommendation-action > div strong { color:#e6eef2;font-size:.69rem;overflow-wrap:anywhere; }.recommendation-action footer { color:#d9a72e;border-top:1px solid rgba(141,163,180,.12);margin-top:13px;padding-top:10px;font-size:.64rem; }
.decision-step { min-height:125px;display:flex;flex-direction:column;align-items:center;text-align:center;gap:7px;border:1px solid rgba(38,198,229,.17);background:linear-gradient(145deg,rgba(8,36,45,.95),rgba(5,22,31,.98));border-radius:12px;padding:14px; }.decision-step > span { color:#53d8ee;font-size:27px; }.decision-step strong { color:#f4f7fb;font:600 .82rem Manrope; }.decision-step small { color:#8299a7;font-size:.65rem;line-height:1.35; }
.ml-policy { display:flex;gap:16px;align-items:center;margin:16px 0 22px;padding:18px 20px;border:1px solid rgba(39,209,127,.28);border-radius:16px;background:linear-gradient(135deg,rgba(39,209,127,.10),rgba(27,178,210,.05));box-shadow:0 12px 32px rgba(0,0,0,.12); }.ml-policy > span { display:grid;place-items:center;width:46px;height:46px;flex:0 0 46px;border-radius:14px;background:rgba(39,209,127,.14);color:#27d17f;font-size:1.65rem; }.ml-policy small { display:block;color:#27d17f;font-size:.66rem;font-weight:800;letter-spacing:.14em; }.ml-policy strong { display:block;margin:3px 0;font:600 1rem Manrope;color:#f4f7fb; }.ml-policy p { margin:0;color:#91a5b1;font-size:.82rem; }
.copilot-hero { display:flex;align-items:center;justify-content:space-between;gap:20px;margin:8px 0 18px;padding:24px 26px;border:1px solid rgba(38,198,229,.24);border-radius:18px;background:radial-gradient(circle at 88% 20%,rgba(38,198,229,.16),transparent 35%),linear-gradient(135deg,rgba(8,36,45,.98),rgba(5,22,31,.99));box-shadow:0 16px 38px rgba(0,0,0,.16); }.copilot-hero small { color:#53d8ee;font-size:.66rem;font-weight:800;letter-spacing:.16em; }.copilot-hero h2 { margin:4px 0;color:#f4f7fb;font:700 clamp(1.3rem,2.2vw,2rem) Manrope; }.copilot-hero p { margin:0;color:#91a5b1;font-size:.86rem; }.copilot-hero>span { color:#53d8ee;font-size:3.2rem; }.copilot-confidence { display:flex;flex-wrap:wrap;gap:8px;margin:12px 0 7px; }.copilot-confidence span { display:inline-flex;align-items:center;gap:5px;padding:6px 9px;border:1px solid rgba(39,209,127,.18);border-radius:999px;background:rgba(39,209,127,.08);color:#a8bac4;font-size:.68rem;font-weight:700; }.copilot-confidence i { color:#27d17f;font-size:15px; }.copilot-empty { display:flex;min-height:180px;flex-direction:column;align-items:center;justify-content:center;gap:7px;margin:18px 0;padding:24px;border:1px dashed rgba(38,198,229,.24);border-radius:16px;background:rgba(8,36,45,.48);text-align:center; }.copilot-empty>span { color:#53d8ee;font-size:2.4rem; }.copilot-empty strong { color:#f4f7fb;font:600 1rem Manrope; }.copilot-empty small { color:#91a5b1; }
.welcome-hero { min-height:435px;display:flex;flex-direction:column;justify-content:center;padding:38px 32px;border:1px solid rgba(217,167,46,.25);background:radial-gradient(circle at 12% 10%,rgba(217,167,46,.13),transparent 24%),radial-gradient(circle at 80% 80%,rgba(39,209,127,.10),transparent 26%),linear-gradient(145deg,rgba(8,32,42,.98),rgba(3,14,24,.99));border-radius:22px;box-shadow:0 24px 60px rgba(0,0,0,.2); }.welcome-badge { width:max-content;display:flex;align-items:center;gap:7px;color:#d9a72e;background:rgba(217,167,46,.08);border:1px solid rgba(217,167,46,.22);border-radius:8px;padding:7px 10px;font-size:.61rem;font-weight:800;letter-spacing:.1em; }.welcome-badge span { font-size:17px; }.welcome-hero h1 { color:#f4f7fb!important;font:700 clamp(2.4rem,5vw,4.6rem) Manrope!important;line-height:1.02;margin:26px 0 18px;letter-spacing:-.045em; }.welcome-hero h1 em { color:#76e8ad;font-style:normal; }.welcome-hero > p { max-width:700px;color:#9fb2bd;font-size:1.04rem;line-height:1.55; }.welcome-proof { display:flex;flex-wrap:wrap;gap:10px;margin-top:24px; }.welcome-proof span { color:#9eb0bc;border:1px solid rgba(141,163,180,.14);background:rgba(141,163,180,.05);border-radius:9px;padding:8px 11px;font-size:.71rem; }.welcome-proof b { color:#f4f7fb;font:700 .9rem Manrope;margin-right:3px; }.welcome-features { display:grid;grid-template-columns:repeat(3,1fr);gap:9px;margin-top:11px; }.welcome-features > div { min-height:112px;display:flex;flex-direction:column;gap:5px;border:1px solid rgba(141,163,180,.14);background:rgba(7,28,36,.7);border-radius:12px;padding:13px; }.welcome-features span { color:#53d8ee;font-size:23px; }.welcome-features strong { color:#edf3f6;font:.78rem Manrope; }.welcome-features small { color:#7f96a4;font-size:.65rem;line-height:1.38; }
.auth-title { padding:12px 0 10px; }.auth-title > span { color:#d9a72e;font-size:.63rem;font-weight:800;letter-spacing:.11em; }.auth-title h2 { color:#f4f7fb!important;font:700 1.85rem Manrope!important;margin:7px 0 4px; }.auth-title p { color:#8da3b4;font-size:.78rem; }.auth-divider { display:flex;align-items:center;gap:8px;color:#718996;font-size:.65rem;margin:14px 0 5px; }.auth-divider:before,.auth-divider:after { content:'';height:1px;flex:1;background:rgba(141,163,180,.16); }
.account-card { display:flex;align-items:center;gap:9px;border:1px solid rgba(38,198,229,.15);background:rgba(38,198,229,.05);border-radius:10px;padding:9px 10px;margin:4px 0 8px; }.account-card > span { color:#53d8ee;font-size:25px; }.account-card > div { min-width:0;display:flex;flex-direction:column;gap:2px; }.account-card strong { color:#edf3f6;font-size:.72rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap; }.account-card small { color:#7f96a4;font-size:.6rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap; }
.onboarding-hero { display:flex;align-items:center;gap:20px;border:1px solid rgba(217,167,46,.25);background:linear-gradient(120deg,rgba(13,44,50,.97),rgba(5,21,30,.99));border-radius:18px;padding:24px;margin:6px 0 17px; }.onboarding-hero > span { width:70px;height:70px;display:grid!important;place-items:center;border-radius:17px;background:rgba(39,209,127,.1);color:#76e8ad;font-size:36px; }.onboarding-hero small { color:#d9a72e;font-size:.61rem;font-weight:800;letter-spacing:.1em; }.onboarding-hero h1 { color:#f4f7fb!important;font:700 1.75rem Manrope!important;margin:4px 0; }.onboarding-hero p { color:#9eb0bc;margin:0;font-size:.78rem; }.onboarding-step { min-height:145px;display:grid;grid-template-columns:auto 1fr;grid-template-rows:auto auto 1fr;gap:4px 10px;border:1px solid rgba(38,198,229,.15);background:linear-gradient(145deg,rgba(8,35,45,.95),rgba(5,21,30,.98));border-radius:13px;padding:15px;margin-bottom:12px; }.onboarding-step b { grid-row:1/4;color:#d9a72e;font:700 1.1rem Manrope; }.onboarding-step > span { color:#53d8ee;font-size:24px; }.onboarding-step strong { color:#edf3f6;font:.82rem Manrope; }.onboarding-step small { color:#8299a7;font-size:.68rem;line-height:1.4; }
...
@media (max-width: 768px) {
  ...
  .decision-alert-kpis { grid-template-columns:1fr 1fr; }.decision-alert-explain { grid-template-columns:1fr; }.recommendation-action { min-height:auto; }.recommendation-action > div { grid-template-columns:1fr 1fr; }.decision-step { min-height:auto; }
  .welcome-hero { min-height:auto;padding:25px 20px; }.welcome-hero h1 { font-size:2.35rem!important; }.welcome-features { grid-template-columns:1fr; }.welcome-features > div { min-height:auto; }.onboarding-hero { align-items:flex-start;padding:18px; }.onboarding-hero > span { width:48px;height:48px;font-size:26px; }.onboarding-hero h1 { font-size:1.28rem!important; }
...
@media (max-width: 600px) {
  ...
  .copilot-hero { padding:18px;align-items:flex-start; }.copilot-hero>span { font-size:2.2rem; }.copilot-confidence { flex-direction:column;align-items:stretch; }.copilot-confidence span { border-radius:9px; }
}
</style>
"""
...
.decision-alert,.recommendation-action,.decision-step { background:linear-gradient(145deg,#ffffff,#eef4f5);border-color:#d5e1e5;box-shadow:0 9px 23px rgba(25,48,60,.06); }.decision-alert-head strong,.decision-alert-kpis strong,.recommendation-action header strong,.recommendation-action > div strong,.decision-step strong { color:#18313c; }.decision-alert-head > b,.decision-alert-explain p,.decision-alert footer,.recommendation-action > p,.recommendation-action footer,.decision-step small { color:#526a78; }.decision-alert-kpis > div { background:#f5f8f9;border-color:#dce5e8; }.recommendation-action footer { border-color:#d8e2e6; }.ml-policy { background:linear-gradient(135deg,#f2fbf6,#f5fbfc);border-color:#b9dfca;box-shadow:0 9px 23px rgba(25,48,60,.06); }.ml-policy strong { color:#18313c; }.ml-policy p { color:#526a78; }.copilot-hero { background:radial-gradient(circle at 88% 20%,rgba(38,198,229,.12),transparent 35%),linear-gradient(135deg,#fff,#eef7f8);border-color:#c9e0e5;box-shadow:0 9px 23px rgba(25,48,60,.07); }.copilot-hero h2,.copilot-empty strong { color:#18313c; }.copilot-hero p,.copilot-empty small,.copilot-confidence span { color:#526a78; }.copilot-empty { background:#f5f9fa;border-color:#c9dce2; }.copilot-confidence span { background:#f2fbf6;border-color:#b9dfca; }
.welcome-hero,.welcome-features > div,.onboarding-hero,.onboarding-step { background:linear-gradient(145deg,#ffffff,#edf4f4);border-color:#d6e2e6;box-shadow:0 12px 28px rgba(25,48,60,.07); }.welcome-hero h1,.welcome-proof b,.welcome-features strong,.onboarding-hero h1,.onboarding-step strong,.auth-title h2 { color:#18313c!important; }.welcome-hero > p,.welcome-proof span,.welcome-features small,.onboarding-hero p,.onboarding-step small,.auth-title p { color:#526a78; }.welcome-features > div { background:#f7fafb; }.account-card { background:#eef8fa; }.account-card strong { color:#18313c; }.account-card small { color:#526a78; }
