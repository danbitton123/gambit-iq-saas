...
def render(ctx)->None:
    ...
    kpis([("Players Targetable",f"{int(m.targetable):,}","Active and safety-filtered"),("Modelled Opportunity",money(m.revenue),"8% of predicted 90D LTV"),("Demo Uplift Assumption","+23.6%","Not an observed experiment"),("Bonus Efficiency","Not available","Requires bonus-cost data"),("Suppressed for Risk",f"{int(m.suppressed):,}","Fraud or RG score ≥55%")])
